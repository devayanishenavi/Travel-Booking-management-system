...
CREATE TABLE IF NOT EXISTS CustomerDetails_DTravels (
...
INSERT INTO CustomerDetails_DTravels(CustomerID, FullName, Email, Phone, Identity_proof)
VALUES
    (1, 'Devayani Shenavi', 'shenavidevayani@gmail.com', '9345698768', 'Aadhar'),
    (2, 'Charu Gupta', 'charu2904@gmail.com', '9876543210', 'Passport'),
    (3, 'Anuja Patil', 'ap2404@gmail.com', '7890123456', 'Driver License'),
    (4, 'Devika Ranmale', 'devika23@gmail.com', '2345678901', 'Aadhar'),
    (5, 'Arya shinde', 'Arya@gmail.com', '8901234567', 'Passport'),
    (6, 'Veena Deshpande', 'vd567@gmail.com', '3456789012', 'Driver License'),
    (7, 'Shital Nagvenkar', 'shtlnad@gmail.com', '9012345678', 'Aadhar'),
    (8, 'Vikram Nadkarni', 'viks01@gmail.com', '4567890123', 'Passport'),
    (9, 'Aryan patil', 'aryan56@gmail.com', '0123456789', 'Driver License'),
    (10, 'Veer Patil', 'vp3til@gmail.com', '9398631146', 'Aadhar');

CREATE TABLE IF NOT EXISTS Employee_DTravels (
...
INSERT INTO Employee_DTravels (EmployeeID, Emp_name, Department, Emp_salary, Emp_Position)
VALUES
    (1, 'Vivean patil', 'Bus', 54000, 'Driver'),
    (2, 'Sonia shetty', 'Car', 55000, 'Guide'),
    (3, 'Vansh Dhekle', 'Train', 60000, 'Supervisor'),
    (4, 'Pratham potdar', 'Flight', 65000, 'Booking Agent'),
    (5, 'Amit Singh', 'Cruise', 70000, 'Guide'),
    (6, 'Sunita kale', 'Bus', 50000, 'Driver'),
    (7, 'Rahul Verma', 'Car', 60000, 'Supervisor'),
    (8, 'Vivek pise', 'Flight', 70000, 'Guide'),
    (9, 'Anjali patil', 'Train', 65000, 'Booking Agent'),
...
CREATE TABLE IF NOT EXISTS Trains_DTravels (
...
INSERT INTO Trains_DTravels(TrainID, TrainName, T_DepartureTime, T_ArrivalTime, T_Origin, T_Destination, DestinationID)
VALUES
...
CREATE TABLE IF NOT EXISTS Payment_chahel (
    ...
    PaymentDate DATE,
    CustomerID INT,
    FOREIGN KEY (CustomerID) REFERENCES CustomerDetails_DTravels(CustomerID)
);
